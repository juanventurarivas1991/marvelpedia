...
import com.juan.marvelpedia.modelRelatedCharacters.Result;
...
public class RecyclerCharactesrRelacionados extends RecyclerView.Adapter<RecyclerCharactesrRelacionados.RelacionadoViewHolder> {
    ...
    RecyclerCharactesrRelacionados(List<Result> resultados, Context context) {
        this.resultados = resultados;
        this.context = context;
    }

    @Override
    public RecyclerCharactesrRelacionados.RelacionadoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RecyclerCharactesrRelacionados.RelacionadoViewHolder pvh = new RecyclerCharactesrRelacionados.RelacionadoViewHolder(v);
        //Devolvemos el ViewHolder inicializado
        return pvh;
    }

    @Override
    public void onBindViewHolder(RecyclerCharactesrRelacionados.RelacionadoViewHolder holder, final int position) {
        //Asignamos los datos del Array de Objetos Contacto a cada ViewHolder de la lista
        holder.cv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                ((Detalle) context).id = Integer.parseInt(resultados.get(position).getId());
                ((Detalle) context).cargarPersonaje();
                ((Detalle) context).cargarComicsRelacionados();
